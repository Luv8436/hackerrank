...
DoublyLinkedListNode* sortedInsert(DoublyLinkedListNode* head, int data) {
    struct DoublyLinkedListNode *ptr=head;
    struct DoublyLinkedListNode *avail=(struct DoublyLinkedListNode *)malloc(sizeof(struct DoublyLinkedListNode));
    struct DoublyLinkedListNode *ptr2=NULL;
    avail->next=NULL;
    avail->prev=NULL;
    avail->data=data;
    while(ptr!=NULL)
